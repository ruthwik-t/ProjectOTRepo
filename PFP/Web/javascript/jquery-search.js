...
$(document).ready(function(){
  ...
  $('.look_right input').on('focus', function(){
  $(this).closest(".look_right").addClass('topview')
  });

$('.floating_coln input').on('focus', function(){
  $(this).closest(".floating_coln").addClass('topview')
  });
