...
public class CRM_Util extends CRM_UtilBase
{
...
private static String libServer;
  private static DKDatastoreICM dsICM;
    ...
    public CRM_Util(BusObjectConfig config)
    {
        super(config);
    }
...
private static int highestNumber(DKParts parts) throws DKException, Exception 
    ...
    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.CRM_Util> getCRM_UtilObjects(com.cordys.cpc.bsf.query.Cursor cursor)
    {
        // TODO implement body
        return null;
    }
