...
public abstract class dropdown_tableBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.dropdown_table> getDropdownValuesByType(String Identifier)
    {
        String queryText = "select * from \"dropdown_table\" where \"Identifier\" = :Identifier";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("Identifier", "dropdown_table.Identifier", QueryObject.PARAM_STRING, Identifier);//NOPMD
        query.setResultClass(dropdown_table.class);
        return query.getObjects();
    }

    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.dropdown_table> getDropdown_tableObjects(com.cordys.cpc.bsf.query.Cursor cursor)
    {
    ...
    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.dropdown_table> getDropdown_tableObjects()
    {
        String queryText = "select * from \"dropdown_table\"";
        QueryObject query = new QueryObject(queryText);
        query.setResultClass(dropdown_table.class);
