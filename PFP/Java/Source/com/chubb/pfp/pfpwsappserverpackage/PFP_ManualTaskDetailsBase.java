...
public abstract class PFP_ManualTaskDetailsBase extends com.cordys.cpc.bsf.busobject.StateBusObject
{
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(PFP_ManualTaskDetails.class);
            s_classInfo.setTableName("PFP_ManualTaskDetails");
    ...
    public PFP_ManualTaskDetailsBase(BusObjectConfig config)
    {
        super(config);
    }
    ...
    public static com.chubb.pfp.pfpwsappserverpackage.PFP_ManualTaskDetails getManualTaskDetailsOfCaseID(String CaseID)
    {
        String queryText = "select * from \"PFP_ManualTaskDetails\" where \"CaseID\" = :CaseID";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("CaseID", "PFP_ManualTaskDetails.CaseID", QueryObject.PARAM_STRING, CaseID);//NOPMD
        query.setResultClass(PFP_ManualTaskDetails.class);
        return (PFP_ManualTaskDetails)query.getObject();
    }

    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.PFP_ManualTaskDetails> getManualTasksByStatusAndDestination(String Status, String Department)
    {
        String queryText = "select * from \"PFP_ManualTaskDetails\" where \"Status\" = :Status and \"DestinationWorkList\" = :Department";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("Status", "PFP_ManualTaskDetails.Status", QueryObject.PARAM_STRING, Status);//NOPMD
        query.addParameter("Department", "PFP_ManualTaskDetails.DestinationWorkList", QueryObject.PARAM_STRING, Department);//NOPMD
        query.setResultClass(PFP_ManualTaskDetails.class);
        return query.getObjects();
    }

    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.PFP_ManualTaskDetails> getNextPFP_ManualTaskDetailsObjects(int SNO, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"PFP_ManualTaskDetails\" where (\"SNO\" > :SNO) order by \"SNO\" asc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("SNO", "PFP_ManualTaskDetails.SNO", QueryObject.PARAM_INT, new Integer(SNO));//NOPMD
        query.setResultClass(PFP_ManualTaskDetails.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static com.chubb.pfp.pfpwsappserverpackage.PFP_ManualTaskDetails getPFP_ManualTaskDetailsObject(int SNO)
    {
    ...
    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.PFP_ManualTaskDetails> getPFP_ManualTaskDetailsObjects(int fromSNO, int toSNO, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"PFP_ManualTaskDetails\" where \"SNO\" between :fromSNO and :toSNO";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromSNO", "PFP_ManualTaskDetails.SNO", QueryObject.PARAM_INT, new Integer(fromSNO));
        query.addParameter("toSNO", "PFP_ManualTaskDetails.SNO", QueryObject.PARAM_INT, new Integer(toSNO));
        query.setResultClass(PFP_ManualTaskDetails.class);
        query.setCursor(cursor);
        return query.getObjects();
    }

    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.PFP_ManualTaskDetails> getPFP_ManualTaskDetailsObjects(int fromSNO, int toSNO)
    {
        String queryText = "select * from \"PFP_ManualTaskDetails\" where \"SNO\" between :fromSNO and :toSNO";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("fromSNO", "PFP_ManualTaskDetails.SNO", QueryObject.PARAM_INT, new Integer(fromSNO));
    ...
    public static BusObjectIterator<com.chubb.pfp.pfpwsappserverpackage.PFP_ManualTaskDetails> getPreviousPFP_ManualTaskDetailsObjects(int SNO, com.cordys.cpc.bsf.query.Cursor cursor)
    {
        String queryText = "select * from \"PFP_ManualTaskDetails\" where (\"SNO\" < :SNO) order by \"SNO\" desc";
        QueryObject query = new QueryObject(queryText);
        query.addParameter("SNO", "PFP_ManualTaskDetails.SNO", QueryObject.PARAM_INT, new Integer(SNO));//NOPMD
        query.setResultClass(PFP_ManualTaskDetails.class);
        query.setCursor(cursor);
